...
export const articles: Article[] = [
    {
        ...
        description:
            "Exploring the shift towards decoupled frontend and backend systems for scalable e-commerce.",
        excerpt:
            "Learn how headless commerce architecture enables omnichannel experiences and faster time-to-market.",
    ...
    },
    {
        ...
        description:
            "Techniques and best practices for rendering complex 3D graphics on resource-constrained devices.",
        excerpt:
            "Master WebGL optimization techniques to deliver smooth 3D experiences on mobile devices.",
    ...
    },
    {
        ...
        description:
            "Designing autonomous agents that can handle complex workflows and large-scale data processing.",
        excerpt:
            "Build intelligent AI agents that scale from prototype to production with modern frameworks.",
    ...
    },
    {
        ...
        description:
            "How subtle animations and feedback loops significantly improve user engagement and retention.",
        excerpt:
            "Discover how micro-interactions create delightful experiences that keep users coming back.",
