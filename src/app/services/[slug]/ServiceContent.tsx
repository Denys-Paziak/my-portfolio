...
export default function ServiceContent({ params }: { params: { slug: string } }) {
    ...
    const serviceData = {
        "web-development": {
            ...
            subtitle:
                "Beyond simple websites. We engineer high-performance web platforms that drive business growth.",
            ...
            capabilities: [
                {
                    ...
                    desc: "Instant initial load and perfect SEO with Next.js SSR.",
                    icon: <Server className="w-6 h-6" />,
                    colSpan: "md:col-span-2",
                },
                {
                    title: "Edge Computing",
                    desc: "Logic running closer to your users for zero latency.",
                    icon: <Zap className="w-6 h-6" />,
                    colSpan: "md:col-span-1",
                },
                {
                    title: "Headless CMS",
                    desc: "Empower marketing teams without breaking code.",
                    icon: <Database className="w-6 h-6" />,
                    colSpan: "md:col-span-1",
                },
                {
                    title: "Real-time Sockets",
                    desc: "Live updates for chat, notifications, and data.",
                    icon: <Zap className="w-6 h-6" />,
                    colSpan: "md:col-span-2",
                },
                {
                    title: "Type Safety",
                    desc: "End-to-end TypeScript for bug-free deployments.",
                    icon: <Shield className="w-6 h-6" />,
                    colSpan: "md:col-span-1",
                },
                {
                    title: "Automated Testing",
                    desc: "CI/CD pipelines with Jest and Cypress.",
            ...
            process: [
                {
                    ...
                    desc: "We analyze your business goals, audit existing systems, and define the technical roadmap.",
                    deliverable: "Technical Specification Doc",
                },
                {
                    title: "UX/UI Design",
                    desc: "Creating high-fidelity prototypes and design systems that ensure consistency.",
                    deliverable: "Figma Design System",
                },
                {
                    title: "Agile Development",
                    desc: "Iterative sprints with bi-weekly demos. You see the product evolve in real-time.",
                    deliverable: "Production-Ready Code",
                },
                {
                    title: "QA & Launch",
                    desc: "Rigorous testing across devices, security audits, and a zero-downtime deployment.",
            ...
            faq: [
                {
                    ...
                    a: "We use a combination of server-side rendering, image optimization, code splitting, and edge caching to ensure sub-second load times.",
                },
                {
                    q: "Can you migrate our legacy app?",
                    a: "Yes, we specialize in incremental migration strategies (Strangler Fig pattern) to modernize legacy systems without downtime.",
                },
                {
                    q: "Do you provide post-launch support?",
                    a: "Absolutely. We offer SLA-backed support packages including 24/7 monitoring, security patches, and feature updates.",
                },
            ],
        },
        ...
        default: {
            ...
            subtitle:
                "Detailed information about this service is being prepared. Contact us for a custom proposal.",
            ...
            process: [
                { title: "Consultation", desc: "Understanding needs.", deliverable: "Proposal" },
            ],
                        ...
                        <div className="grid grid-cols-3 gap-8 md:gap-16 border-t border-white/10 pt-8 max-w-3xl">
                            {service.metrics.map((stat, i) => (
                                <div key={i}>
                                    ...
                                    <div className="text-xs md:text-sm font-mono text-white/40 uppercase tracking-widest">
                                        {stat.label}
                                    </div>
                                </div>
                            ))}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
                        ...
                        <div className="space-y-8 opacity-60 hover:opacity-100 transition-opacity duration-500">
                            <div className="flex items-center gap-4 mb-8">
                                ...
                                <Heading level={3} className="text-3xl font-bold text-white/80">
                                    The Old Way
                                </Heading>
                            </div>
                        ...
                        <div className="space-y-8 relative">
                            ...
                            <div className="flex items-center gap-4 mb-8 relative z-10">
                                ...
                                <Heading level={3} className="text-3xl font-bold text-white">
                                    The Radical Way
                                </Heading>
                            </div>
                ...
                <Container>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[240px]">
                        {service.capabilities.map((cap, i) => (
                            <BentoCard
                                key={i}
                                className={`${cap.colSpan} flex flex-col justify-between group`}
                            >
            ...
            <section className="py-32 border-t border-white/5">
                <Container>
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        ...
                        <Text variant="muted" className="text-lg">
                            Our stack is chosen for performance, scalability, and developer
                            experience.
                        </Text>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        {service.stack.map((tech, i) => (
                            <div
                                key={i}
                                className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] flex flex-col items-center justify-center text-center hover:border-white/10 transition-colors group"
                            >
                                <div className="text-white font-bold mb-1 group-hover:text-accent transition-colors">
                                    {tech.name}
                                </div>
            ...
            <section className="py-32">
                <Container>
                    <div className="max-w-3xl mx-auto">
                        <Heading level={2} className="text-4xl font-bold mb-16 text-center">
                            Common Questions
                        </Heading>
