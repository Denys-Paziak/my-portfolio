...
export function CTA() {
    return (
        <section id="contact" className="relative w-full py-24 md:py-32 overflow-hidden bg-background border-t border-[var(--glass-border)]">
            {/* Background Elements */}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <Text size="lg" variant="muted" className="max-w-md">
                                Have a project in mind? Fill out the form or play with the blocks on the right to find me elsewhere.
                            </Text>
                        </div>
                    ...
                    <div className="relative h-[500px] md:h-[600px] w-full bg-white/[0.02] rounded-3xl border border-white/10 overflow-hidden shadow-2xl flex items-center justify-center">
                        <div className="text-center p-8">
                            <Terminal className="w-16 h-16 text-accent mx-auto mb-6 opacity-50" aria-hidden="true" />
                            <Heading level={3} className="text-2xl md:text-3xl font-bold mb-4">Ready to Deploy?</Heading>
