...
export const metadata: Metadata = {
  ...
  description: "Building clean, modern backend with Python. Scalable systems, high-performance applications, and digital excellence.",
  keywords: ["backend developer", "Python", "Next.js", "React", "full stack", "software engineer"],
